...
/* --------------------------- NOTE GOOGLE SIGNIN --------------------------- */
  ...
  static Future<User?> signInWithGoogle() async {
    try {
      ...
      // Initialize with scopes - THIS IS THE KEY CHANGE
      await googleSignIn.initialize(
        // clientId: clientId, // Optional: if you need web client ID
        // scopes: ['email'],  // Pass scopes here
      );

      // Or simpler - just authenticate without explicit initialization
      // The scopes might be configured in platform files instead
