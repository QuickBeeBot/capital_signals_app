...
class ZUtils {
  /// Safe context resolution for dialogs/toasts
  ...
  static Widget splitUpdateTextColumn({required String message, required BuildContext context}) {
    List<String> splitText = message.split('*').map((e) => e.trim()).toList();
...
class _AnimatedDialogState extends State<_AnimatedDialog> with SingleTickerProviderStateMixin {
