...
// const primary = Color(0xFF02143E);
const primary = Color(0xFF0D0E14);
const mainColor = Color(0xFF000000);
const secondary = Color(0xFFe54140);
const appBgColor = Color(0xFFbdc0f7);
const appBgColorPrimary = Color(0xFF0D0E14);
const appTextColor = Color(0xFFE2AA3A);
const appBgColorSecondary = Color(0xFF0D0E14);
// const appBgColorPrimary = Color(0xFF02143E);
// const appBgColorSecondary = Color(0xFF09215B);
